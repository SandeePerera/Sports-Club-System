package lk.iit.oop;
import lk.iit.oop.Exceptions.PointComparator;
import lk.iit.oop.GUI.MatchTableGUI;
...
public class PremierLeagueManager implements LeagueManager {
        ...
        if (sportsClubList.isEmpty()) {
            ...
            for (SportsClub sportsClub : sportsClubList) {
                if (sportsClub.getClub_name().equals(club_name)) {
                    ...
                    foundclub = true;
                    System.out.println("  You enterd club -:  " + club_name);
                    System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    ...
    @Override
    public void update_match(String club_name, String clubTname, int pointOne, int pointTwo) {
        boolean foundclub = false;
        for (SportsClub sportsClub : sportsClubList) {
            if (sportsClub.getClub_name().equals(club_name)) {

                //sportsClubList.update(sportsClub);
